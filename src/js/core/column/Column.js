...
export default class Column extends CoreFeature {
	...
	constructor(def, parent, rowHeader) {
		...
		this.align = ""; //horizontal text alignment
		this.vAlign = ""; //vert text alignment
	...
	createElement() {
		...
		switch (this.table.options.columnHeaderValign) {
			case "middle":
	...
	_buildColumnHeader() {
		...
		this.align = this.definition.align;
		this.vAlign = this.definition.vAlign;

		this.titleElement.style.textAlign = this.definition.headerAlign;
	}
